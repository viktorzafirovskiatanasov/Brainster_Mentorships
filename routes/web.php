...
Route::middleware('auth')->group(function () {
    ...
    Route::get('appointment/create', [\App\Http\Controllers\AppointmentsController::class, 'create'])
        ->name('appointment.create');


    Route::post('appointment/store', [\App\Http\Controllers\AppointmentsController::class, 'store'])
